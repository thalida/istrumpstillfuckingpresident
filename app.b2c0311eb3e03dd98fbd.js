...
/***/ function(module, exports, __webpack_require__) {
	...
	window.requireAll = __webpack_require__(3).requireAll;
...
/***/ function(module, exports, __webpack_require__) {
	...
	requireAll(__webpack_require__(121));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		"./actions/actions.scss": 142,
		"./answer/answer.scss": 143,
		"./footer/footer.scss": 144,
		"./header/header.scss": 145,
		"./joy/joy.scss": 146
	};
	function webpackContext(req) {
		return __webpack_require__(webpackContextResolve(req));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var closest = __webpack_require__(135);
...
/***/ function(module, exports) {
	...
	module.exports = [
		{
			"active": false,
			"title": "Place text here. Must be <100 characters!",
			"description": "Place text here. Must be <100 characters!",
			"url": "http://foobar.com"
		},
		{
			"active": false,
			"title": "Place text here. Must be <100 characters!",
			"description": "Place text here. Must be <100 characters!",
			"source": "http://twitter.com/thalidanoel"
		},
		{
			"active": false,
			"title": "Place text here. Must be <100 characters!",
	...
	module.exports = [
		{
			"active": true,
			"type": "text",
			"text": "~1.5 Millon Fucking People Participated in the Women’s March Around the World",
			"source": "http://foobar.com"
		},
		{
			"active": true,
			"type": "spotify",
			"title": "Self Preservation Playlist",
			"uri": "spotify:user:ohbunnystack:playlist:6d7qWYZ7y5hOdtnTPEq9mB"
		},
		{
			"active": true,
			"type": "text",
			"text": "A Nazi Was Punched In the Face"
		},
		{
			"active": true,
			"type": "twitter",
			"url": "https://twitter.com/ibizoboi/status/823199147960528900"
		},
		{
			"active": true,
			"type": "image",
			"url": "http://www.pbh2.com/wordpress/wp-content/uploads/2013/05/cutest-cat-gifs-licking.gif",
			"source": "http://foobar.com"
		},
		{
			"active": true,
		...
		},
		{
			"active": true,
			"type": "spotify",
			"uri": "spotify:track:5JTAGruCIDyRLhKLwFkTnS"
		}
	];
...
/***/ function(module, exports) {
	...
	angular
	.module('app')
	.filter('fuck', ["IS_FUCK_ENABLED", function (IS_FUCK_ENABLED) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ngstorage = __webpack_require__(119);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var requireAll = __webpack_require__(3).requireAll;
	requireAll(__webpack_require__(122));
...
/***/ function(module, exports) {
	...
	service.$inject = ["utils", "IS_FUCK_ENABLED", "IS_STILL_PRESIDENT", "NEGATIVE_ANSWERS", "POSITIVE_ANSWERS", "JOY_COLLECTION", "ACTIONS_COLLECTION"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var service = function (IS_FUCK_ENABLED) {
		...
		Sites.prototype.setSisterSite = function () {
			var urls = ( true) ? this.prod : this.dev;
	...
	service.$inject = ["IS_FUCK_ENABLED"];
...
/***/ function(module, exports) {
	...
	Controller.$inject = ["$state", "$stateParams", "$timeout", "utils", "sitesService", "Collection", "IS_FUCK_ENABLED", "IS_STILL_PRESIDENT", "NEGATIVE_ANSWERS", "POSITIVE_ANSWERS", "JOY_COLLECTION", "ACTIONS_COLLECTION"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	window.requireAll(__webpack_require__(126));
	...
	* Copyright (c) 2016 Sachin; Licensed MIT */
	(function() {
	    ...
	    if (typeof module === 'object' && module.exports) {
	      ...
	      Clipboard = __webpack_require__(134);
...
/***/ function(module, exports) {
	...
	var html = "<div class=twitter-component ng-show=$ctrl.render ng-bind-html=$ctrl.embed></div> ";
...
/***/ function(module, exports) {
	...
	var html = "<div class=main-view ng-cloak ng-class=\"[\n        {\n            'is-answer-state': $ctrl.state.currentView === 'answer',\n            'is-joy-state': $ctrl.state.currentView === 'joy',\n            'is-actions-state': $ctrl.state.currentView === 'actions',\n        }\n     ]\" ng-if=$ctrl.render> <div ng-include=\"'views/main/partials/header/header.html'\"></div> <div class=content> <div ng-if=\"$ctrl.state.currentView === 'answer'\" ng-include=\"'views/main/partials/answer/answer.html'\"></div> <div ng-if=\"$ctrl.state.currentView === 'joy'\" ng-include=\"'views/main/partials/joy/joy.html'\"></div> <div ng-if=\"$ctrl.state.currentView === 'actions'\" ng-include=\"'views/main/partials/actions/actions.html'\"></div> </div> <div ng-include=\"'views/main/partials/footer/footer.html'\"></div> </div> ";
	window.angular.module('ng').run(['$templateCache', function(c) { c.put(path, html) }]);
	module.exports = path;
...
/***/ function(module, exports) {
	...
	var html = "<div class=actions-section> <h1>Make a {{t|fuck:'ing'}} Difference</h1> <div class=actions-list> <div class=action-item ng-repeat=\"action in $ctrl.actionsCollection.selectedGroup track by $index\"> <h2 class=action-item-title>{{action.title}}</h2> <p class=action-item-description>{{action.description}}</p> <div class=action-item-source ng-if=action.source> source: <a class=\"link link-dark\" ng-href={{action.source}} target=_blank> {{action.source}} </a> </div> <a class=\"action-item-link button\" ng-if=action.url ng-href={{action.url}} target=_blank> Take Action </a> </div> </div> </div> ";
	window.angular.module('ng').run(['$templateCache', function(c) { c.put(path, html) }]);
	module.exports = path;
...
/***/ function(module, exports) {
	...
	var html = "<div class=answer-section> <h1>{{$ctrl.answerCollection.selectedItem}}</h1> </div> ";
	window.angular.module('ng').run(['$templateCache', function(c) { c.put(path, html) }]);
	module.exports = path;
...
/***/ function(module, exports) {
	...
	var html = "<div class=footer> <div class=creator-credit> <a class=link ng-class=\"{'link-dark': $ctrl.state.currentView !== 'answer'}\" href=http://thalida.com target=_blank> <span class=\"emoji emoji-raised-hands\"></span> </a> </div> <div class=ctas> <a class=button href ng-class=\"{'button-dark': $ctrl.state.currentView !== 'answer'}\" ng-click=\"$ctrl.state.go({view: 'joy', id: null})\"> <span ng-show=\"$ctrl.state.currentView === 'joy'\">More {{t|fuck:'ing'}} joy</span> <span ng-hide=\"$ctrl.state.currentView === 'joy'\">Give me some {{t|fuck:'ing'}} joy</span> </a> <a class=button href ng-show=\"$ctrl.actionsCollection.selectedGroup.length > 0\" ng-class=\"{\n               'button-dark': $ctrl.state.currentView === 'joy',\n               'button-clear': $ctrl.state.currentView === 'actions'\n           }\" ng-click=\"$ctrl.state.go({view: 'actions', id: null})\"> Make a {{t|fuck:'ing'}} difference </a> </div> <ul class=additional-info> <li> <a href class=link ng-class=\"{'link-dark': $ctrl.state.currentView !== 'answer'}\" ng-click=$ctrl.sisterSite.go()> {{$ctrl.sisterSite.data.cta}} </a> </li> <li> Emoji by <a class=link ng-class=\"{'link-dark': $ctrl.state.currentView !== 'answer'}\" href=http://emojione.com/ target=_blank> Emoji One </a> </li> </ul> </div> ";
	window.angular.module('ng').run(['$templateCache', function(c) { c.put(path, html) }]);
	module.exports = path;
...
/***/ function(module, exports) {
	...
	var html = "<div class=header> <div class=problem-section> <a href class=\"link question\" ng-class=\"{'link-dark': $ctrl.state.currentView !== 'answer'}\" ng-click=\"$ctrl.state.go({view: 'answer', id: null})\"> Q: Is Trump Still {{t|fuck:'ing'}} President? </a> <div class=answer ng-show=\"$ctrl.state.currentView !== 'answer'\"> A: {{$ctrl.answerCollection.selectedItem}} </div> </div> <div class=share-section ng-show=\"$ctrl.state.currentView === 'joy'\"> <span class=\"clickable icon icon-share\" ngclipboard ngclipboard-success=$ctrl.onCopySuccess(e); ngclipboard-error=$ctrl.onCopyError(e); data-clipboard-text={{$ctrl.state.shareUrl}}> </span> <span class=copy-status ng-class=\"{\n               'is-success': $ctrl.copyStatusType === 'success',\n               'is-error': $ctrl.copyStatusType === 'error',\n               'is-visible': $ctrl.copyStatusVisible === true\n           }\"> <span ng-show=\"$ctrl.copyStatusType === 'success'\">Url copied to clipboard</span> <span ng-show=\"$ctrl.copyStatusType === 'error'\">Error copying url to clipboard</span> </span> </div> </div> ";
	window.angular.module('ng').run(['$templateCache', function(c) { c.put(path, html) }]);
	module.exports = path;
...
/***/ function(module, exports) {
	...
	var html = "<div class=joy-section ng-cloak ng-switch on=$ctrl.joyCollection.selectedItem.type> <div class=text-content ng-switch-when=text> <h2 class=text-body> {{$ctrl.joyCollection.selectedItem.text}} </h2> <div class=source ng-if=$ctrl.joyCollection.selectedItem.source> source: <a class=\"link link-dark\" ng-href={{$ctrl.joyCollection.selectedItem.source}} target=_blank> {{$ctrl.joyCollection.selectedItem.source}} </a> </div> </div> <div class=image-content ng-switch-when=image> <div class=img ng-style=\"{'background-image': 'url({{$ctrl.joyCollection.selectedItem.url}})'}\"/> <div class=source ng-if=$ctrl.joyCollection.selectedItem.source> source: <a class=\"link link-dark\" ng-href={{$ctrl.joyCollection.selectedItem.source}} target=_blank> {{$ctrl.joyCollection.selectedItem.source}} </a> </div> </div> <div class=youtube-content ng-switch-when=youtube> <iframe ng-src=\"{{$ctrl.joyCollection.selectedItem.videoId | youtubeEmbedUrl}}\" width=560 height=315 frameborder=0 allowfullscreen> </iframe> </div> <div class=twitter-content ng-switch-when=twitter> <twitter url={{$ctrl.joyCollection.selectedItem.url}}></twitter> </div> <div class=spotify-content ng-switch-when=spotify> <h2 ng-if=$ctrl.joyCollection.selectedItem.title>{{$ctrl.joyCollection.selectedItem.title}}</h2> <iframe ng-src=\"{{$ctrl.joyCollection.selectedItem.uri | spotifyEmbedUrl}}\" width=300 height=380 frameborder=0 allowtransparency=true> </iframe> </div> </div> ";
	window.angular.module('ng').run(['$templateCache', function(c) { c.put(path, html) }]);
	module.exports = path;
